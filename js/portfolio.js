...
var items = [
  ...
  },
  {
    ...
    key: 'simon',
    dataTarget: '.simon',
    imageLarge: 'img/portfolio/simon1500x800.jpg',
    imageSmall: 'img/portfolio/simon800x600.jpg',
  ...
  },
  {
    ...
    key: 'mem',
    dataTarget: '.mem',
    imageLarge: 'img/portfolio/memEater1500x800.jpg',
    imageSmall: 'img/portfolio/memEater800x600.jpg',
  ...
  },
  {
    ...
    imageSmall: 'img/portfolio/wageBank800x600.png',
  ...
  },
  {
    ...
    imageSmall: 'img/portfolio/summerRip800x600.png',
  ...
  },
  {
    ...
    key: 'wea',
    dataTarget: '.wea',
    imageLarge: 'img/portfolio/weatherrific1500x800.png',
    imageSmall: 'img/portfolio/weatherrific800x600.png',
    description: 'Weatherrific! is a web app that detects a user\'s location and shows them the current temperature along with a description of the weather. The user can also search for the weather in other cities. I completed it while working through the front end development portion of <a href="https://www.freecodecamp.com/" target="_blank">Free Code Camp</a>\'s curriculum.',
    tools: 'HTML, CSS, JavaScript, jQuery, HTML 5 Geolocation, AJAX, <a href="http://openweathermap.org/api" target="_blank">OpenWeatherMap API</a>, <a href="https://api.giphy.com/" target="_blank">Giphy API</a>',
    link: 'http://codepen.io/1gb/full/ZQwPOO/'
  },
  {
    title: 'Downuts',
    key: 'dow',
    ...
    imageSmall: 'img/portfolio/downuts800x600.png',
  ...
  {
    title: 'Marshawn Lynch Random Quote Generator',
    key: 'mar',
    dataTarget: '.mar',
    imageLarge: 'img/portfolio/marshawnQuotes1500x800.png',
    imageSmall: 'img/portfolio/marshawnQuotes800x600.png',
    description: 'The Marshawn Lynch Random Quote Generator is a web app which allows users to recieve snippets of Marshawn Lynch\'s wisdom at a click of a button. I completed it while working through the front end development portion of <a href="https://www.freecodecamp.com/" target="_blank">Free Code Camp</a>\'s curriculum.',
    tools: 'HTML, CSS, JavaScript, Bootstrap',
    link: 'http://codepen.io/1gb/full/YwGyQM/'
  },
  {
    ...
    imageSmall: 'img/portfolio/jscalc800x600.png',
